...
enum {
  ...
  EM_MCS51 = 253,           // Atmel AVR 8-bit microcontroller
};
...
// MCS51 specific e_flags
enum : unsigned {
  EF_MCS51_ARCH_MCS511 = 1,
  EF_MCS51_ARCH_MCS512 = 2,
  EF_MCS51_ARCH_MCS5125 = 25,
  EF_MCS51_ARCH_MCS513 = 3,
  EF_MCS51_ARCH_MCS5131 = 31,
  EF_MCS51_ARCH_MCS5135 = 35,
  EF_MCS51_ARCH_MCS514 = 4,
  EF_MCS51_ARCH_MCS515 = 5,
  EF_MCS51_ARCH_MCS5151 = 51,
  EF_MCS51_ARCH_MCS516 = 6,
  EF_MCS51_ARCH_MCS51TINY = 100,
  EF_MCS51_ARCH_XMEGA1 = 101,
  EF_MCS51_ARCH_XMEGA2 = 102,
  EF_MCS51_ARCH_XMEGA3 = 103,
  EF_MCS51_ARCH_XMEGA4 = 104,
  EF_MCS51_ARCH_XMEGA5 = 105,
  EF_MCS51_ARCH_XMEGA6 = 106,
  EF_MCS51_ARCH_XMEGA7 = 107,

  EF_MCS51_ARCH_MASK = 0x7f, // EF_AVR_ARCH_xxx selection mask

  EF_MCS51_LINKRELAX_PREPARED = 0x80, // The file is prepared for linker
                                    // relaxation to be applied
};
