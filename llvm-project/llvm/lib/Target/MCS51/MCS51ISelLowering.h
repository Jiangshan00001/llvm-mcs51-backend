...
#ifndef LLVM_MCS51_ISEL_LOWERING_H
#define LLVM_MCS51_ISEL_LOWERING_H
...
enum NodeType {
  ...
  /// MCS51 conditional branches. Operand 0 is the chain operand, operand 1
...
} // end of namespace MCS51ISD

class MCS51Subtarget;
class MCS51TargetMachine;

/// Performs target lowering for the MCS51.
class MCS51TargetLowering : public TargetLowering {
public:
  explicit MCS51TargetLowering(const MCS51TargetMachine &TM,
...
private:
  SDValue getMCS51Cmp(SDValue LHS, SDValue RHS, ISD::CondCode CC, SDValue &MCS51cc,
                    SelectionDAG &DAG, SDLoc dl) const;
  SDValue getMCS51Cmp(SDValue LHS, SDValue RHS, SelectionDAG &DAG,
                    SDLoc dl) const;
...
#endif // LLVM_MCS51_ISEL_LOWERING_H
