...
static const MCPhysReg RegList16[] = {
    MCS51::R26R25, MCS51::R25R24, MCS51::R24R23, MCS51::R23R22,
    MCS51::R22R21, MCS51::R21R20, MCS51::R20R19, MCS51::R19R18,
    MCS51::R18R17, MCS51::R17R16, MCS51::R16R15, MCS51::R15R14,
    MCS51::R14R13, MCS51::R13R12, MCS51::R12R11, MCS51::R11R10,
    MCS51::R10R9,  MCS51::R9R8};
...
MachineBasicBlock *MCS51TargetLowering::insertShift(MachineInstr &MI,
  ...
  BuildMI(CheckBB, dl, TII.get(MCS51::DECRd), ShiftAmtReg2)
      .addReg(ShiftAmtReg);
...
MCS51TargetLowering::EmitInstrWithCustomInserter(MachineInstr &MI,
  ...
  BuildMI(*trueMBB, trueMBB->begin(), dl, TII.get(MCS51::PHI), MI.getOperand(0).getReg())
...
MCS51TargetLowering::getConstraintType(StringRef Constraint) const {
  if (Constraint.size() == 1) {
    // See http://www.nongnu.org/MCS51-libc/user-manual/inline_asm.html
    switch (Constraint[0]) {
    default:
      break;
...
MCS51TargetLowering::getRegForInlineAsmConstraint(const TargetRegisterInfo *TRI,
  ...
  if (Constraint.size() == 1) {
    ...
    case 't': // Temporary register: r0.
      if (VT == MVT::i8)
        return std::make_pair(unsigned(MCS51::R0), &MCS51::GPR8RegClass);
      break;
